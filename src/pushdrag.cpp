...
//   thru them... other times if you dont have passdoor they should pushable
//   thru a closed exit but you dont follow.
// * trigger mobprog exit triggers
// * trigger mobprog entry triggers
